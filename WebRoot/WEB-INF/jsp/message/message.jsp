    ...
    <table class="table table-hover text-center">
        ...
        <c:forEach items="${pagers.datas}" var="data" varStatus="l">
            <tr>
                ...
                <td>${data.content}</td>
                <td>
                    <a class="button border-red" href="${ctx}/message/delete?id=${data.id}"><span class="icon-trash-o">删除</span>
                    </a>
                </td>
        ...
        <tr>
            <td colspan="8">
                <div class="pagelist">
                    <!--分页开始-->
                    <pg:pager url="${ctx}/message/findBySql" maxIndexPages="5" items="${pagers.total}" maxPageItems="15"
