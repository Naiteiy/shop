...
<div class="width100 hidden_yh" style="background: #f0f0f0;padding-top: 34px;padding-bottom: 34px;">
    <div class="width1200 hidden_yh center_yh">
        <div id="vipNav">
            ...
            <a href="${ctx}/sc/findBySql" class="on">餐品收藏</a>
                    ...
                    <c:forEach items="${pagers.datas}" var="data" varStatus="l">
                        <a href="${ctx}/item/view?id=${data.itemId}">
                            <div class="width100 hidden_yh"
                                 style="border-bottom: 1px dashed #ddd;padding-top: 10px;padding-bottom: 10px;">
                                ...
                                <div class="right_yh">
                                    <a href="${ctx}/sc/delete?id=${data.id}" class="onfff block_yh tcenter font16"
                                       style="margin-top: 10px;padding: 6px;">取消收藏</a>
                                </div>
                            </div>
                        </a>
                    </c:forEach>
