...
<div class="width100 hidden_yh" style="background: #f0f0f0;padding-top: 34px;padding-bottom: 34px;">
    <div class="width1200 hidden_yh center_yh">
        <div id="vipNav">
            ...
            <a href="${ctx}/sc/findBySql">餐品收藏</a>
            <a href="${ctx}/login/pass">修改密码</a>
        </div>
        <div id="vipRight">
            <div class="font24"
                 style="height: 60px;line-height: 60px;text-indent: 50px;background: #f5f8fa;width:938px;border: 1px solid #ddd;">
                餐品评价
            </div>
            <form action="${ctx}/comment/exAdd" method="post" id="myf">
                <input type="hidden" name="itemId" value="${id}">
                <div class="bj_fff hidden_yh"
                     style="width: 838px;height:120px;border: 1px solid #ddd; margin-top:30px;padding: 50px;">
                    <div class="width100" style="height: 32px;line-height: 32px;">
                        ...
                        <input type="text" name="content"
                               style="width:300px;border: 1px solid #ddd; outline: none;height: 100px;text-indent: 10px;">
                    </div>
                    <div class="width100" style="height: 32px;line-height: 32px;margin-top:85px;">
                        <a href="javascript:void(0)" class="left_yh block_yh font16 tcenter ff5802 con"
                           style="width:240px;height: 33px;line-height: 33px;margin-left: 120px;">
                            保存
                        </a>
                    </div>
                </div>
